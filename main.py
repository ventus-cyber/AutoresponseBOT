...
class AutoResponseBot(commands.Bot):
    ...
    async def on_message(self, message):
        ...
        try:
            ...
            GENERAL_CHANNELS = [1459377653961461772, 1456410377150660649, 1456410313716142112]
            ...
            if message.channel.id in GENERAL_CHANNELS:
                if "crosstrade" in content:
                    ...
                    await message.channel.send(f"👋 Ese tema va en el canal: https://discord.com/channels/1398431314004410490/1456938316984487978")
                elif "trade" in content or "que me das" in content or "que das" in content or "que dan" in content or "que me dan" in content:
                    await message.channel.send(f"💱 Para intercambios usa https://discord.com/channels/1398431314004410490/1456409787276328961 ")
